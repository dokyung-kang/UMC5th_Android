...
class MusicFileRVAdapter (private val albumList: ArrayList<MusicFile>) : RecyclerView.Adapter<MusicFileRVAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): MusicFileRVAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: MusicFileRVAdapter.ViewHolder, position: Int) {
